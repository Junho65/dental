"""Prepare severity crop datasets for bone_loss and furcation_involvement.
...
DEFAULT_MANIFEST = Path(
    "data/detection_periodontal_pdcnn_2class/periodontal_bbox_manifest.csv"
)
...
def _process_lesion(
    ...
    crop_dir = output_dir / lesion_type / "crops"
...
def main() -> None:
    ...
    for lesion_type in ["bone_loss", "furcation_involvement"]:
        ...
        _process_lesion(sub, lesion_type, args.output_dir, args.margin)
