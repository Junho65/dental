"""Evaluate a periodontal detector with metrics, confidence selection, and
...
Usage:
  python scripts/evaluation/eval_periodontal_conf.py --weights <path> --data <yaml> --split val
"""
